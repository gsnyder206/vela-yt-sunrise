...
def generate_qsub(run_dir, snap_dir, filename, galprops_data, run_type, ncpus='12', model='wes', queue='normal',email='rsimons@jhu.edu',walltime='04:00:00',isnap=0,candelize=False):
...
if __name__ == "__main__":
    ...
    for sn in snaps:
        ...
        try:
            ...
            assert os.system('mkdir %s'%snap_dir)
