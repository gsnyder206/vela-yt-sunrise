...
def generate_cameras(normal_vector, distance=100.0, fov=50.0, mov_ang = 0.):
    ...
    camera_set = OrderedDict([
            ['X-Axis',([1.,0.,0.],[0.,-1.,0],False)], #up is north=+y
    ...
    camera_set = OrderedDict([
            ...
            ['revface',([0.,0.,1.],[0.,1.,0],True)],#up is along z
            ])  
...
if __name__ == "__main__":
	...
	a = time.time()
	import yt
	import sunrise_octree_exporter as sunrise_octree_exporter
	...
	for ds in reversed(ts):
		...
		#L = array([0.229307690083501, 0.973325655982054, 0.00742635009091421]) #to Match with C Moody		 
	...
	b = time.time()
	print 'Final time in seconds: ', int(b - a)
