...
def generate_cameras(normal_vector, seed = 0, distance=100.0, fov=50.0, mov_ang = 0., movie = False, segments_random=12, segments_fixed=2):
    '''
...
if __name__ == "__main__":
    ...
    for ds in ts.piter():
        ...
        #update star radii
        #commenting out to use rad=0.01 kpc default for each star -- preserves maximum structure in SF regions.  May revisit.
